...
export const sportBrands = [
    {
        id: 1,
        name: 'New Balance',
        img: 'https://res.cloudinary.com/dmfs1od9n/image/upload/v1744841723/id6MQLb5ga_logos_iz4ffx.svg',
        style: { transition: 'width 1s ease' }
    },   
    {
        id: 2,
    ...
    },   
    {
        id: 10,
        name: 'Fila',
        img: 'https://res.cloudinary.com/dmfs1od9n/image/upload/v1745111679/fila-svgrepo-com_nitwjq.svg',
        style: { transition: 'width 1s ease' }
    },   
]
